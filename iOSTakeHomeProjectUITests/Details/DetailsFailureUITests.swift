...
//
//  Created by Joao Gripp on 11/08/23.
//
...
final class DetailsFailureUITests: XCTestCase {
    ...
    func test_alert_is_shown_when_fails_to_load() {
        ...
        XCTAssertTrue(alert.waitForExistence(timeout: 3), "Should have a alert visible on the screen")
        ...
        XCTAssertEqual(placeholderItems.count, 3, "There should have 3 placeholder items on screen")
