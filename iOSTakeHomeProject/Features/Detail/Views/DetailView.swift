...
//  iOSTakeHomeProject
//
//  Created by Joao Gripp on 28/09/22.
//
...
struct DetailView: View {
    ...
    init(userId: Int) {
        ...
        if UITestingHelper.isUITesting {
            let mock: NetworkingManagerImpl = UITestingHelper.isDetailsNetworkingSuccessful ? NetworkingManagerUserDetailsResponseSuccessMock() :
            ...
            if vm.isLoading {
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 18) {
                        ...
                        .padding(.vertical, 18)
                        .background (
                            Theme.detailBackground, in: RoundedRectangle(cornerRadius: 16, style: .continuous)
                        )
                    }
                    .padding()
                }
